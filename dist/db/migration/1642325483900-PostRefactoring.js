...
exports.PostRefactoring1642325483900 = void 0;
const bcrypt_1 = require("bcrypt");
class PostRefactoring1642325483900 {
    ...
    async up(queryRunner) {
      ...
      CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
        const adminPasswordWithHash = bcrypt_1.default.hashSync('admin', 10);
      ...
      CONSTRAINT "PK_fb213f79ee45060ba925ecd576e" PRIMARY KEY ("id"))`);
        await queryRunner.query(`ALTER TABLE "columns" ADD CONSTRAINT "FK_3f88407849daf390e93035b15ef" FOREIGN KEY ("board_id") REFERENCES "board"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
...
exports.PostRefactoring1642325483900 = PostRefactoring1642325483900;
//# sourceMappingURL=1642325483900-PostRefactoring.js.map