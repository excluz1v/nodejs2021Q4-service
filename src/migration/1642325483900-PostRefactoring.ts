...
export class PostRefactoring1642325483900 implements MigrationInterface {
  ...
  async up(queryRunner: QueryRunner): Promise<this> {
    ...
    await queryRunner.query(
      ...
      "password" character varying(50) NOT NULL, CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "task" (
      "id" character varying NOT NULL,
      "title" character varying(100) NOT NULL,
      "order" integer NOT NULL, "description" text NOT NULL,
      "userId" character varying, "boardId" character varying NOT NULL,
      "columnId" text, CONSTRAINT "PK_fb213f79ee45060ba925ecd576e" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
